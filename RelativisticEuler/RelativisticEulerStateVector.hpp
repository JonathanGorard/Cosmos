#ifndef RelativisticEulerStateVector_hpp
#define RelativisticEulerStateVector_hpp

#include "RelativisticEulerEquationOfState.hpp"
#include <vector>
using namespace std;

class RelativisticEulerStateVector
{
public:
    RelativisticEulerStateVector();
    RelativisticEulerStateVector(double newDensity, double newXVelocity, double newYVelocity, double newZVelocity, double newPressure);
